...
from app.Bot.utils.keyboards import (
    get_markup_question_type, get_markup_status, get_markup_photo,
    get_progress_text, get_step_emoji, get_markup_cancel_confirm,
